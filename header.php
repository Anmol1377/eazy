...
<div id="welcome-panelwpg" class="welcome-panelwpg wpanelbg  " style="border-radius:5px; background-color:#8c52ff; font-size:12px;">
...
?>
                ...
                <a href="#" style="cursor:not-allowed" title="Comming Soon" class="btn btn-app btn-primary stylish">
                    <i class="fas fa-search fa-2px"></i> <?php
                                                            echo esc_html__("Scan", "ezy_sc-text");
                                                            ?>
                </a>
